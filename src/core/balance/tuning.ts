...
export const TUNABLE_GROUPS: TunableGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'combatPaceRefKmh', label: 'Fire-pace: normal at km/h', min: 1, max: 6, step: 0.1 },
      { key: 'combatPaceFloor', label: 'Fire-pace: min rate stopped', min: 0.1, max: 1, step: 0.05 },
      { key: 'combatPaceCeil', label: 'Fire-pace: max rate walking', min: 1, max: 3, step: 0.1 },
